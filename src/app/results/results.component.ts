...
export class ResultsComponent implements OnInit, OnChanges {
  ...
  checkIfLoggedIn() {
    this.authService
      .isLoggedIn()
      .subscribe(res => this.successCallbackUser(res)),
      errorthing => {
        this.errorCallbackUser(errorthing);
      };
  }
